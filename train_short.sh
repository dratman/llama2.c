#!/bin/bash
#Andrej Karpathy's original setup for 260K model:
#This 260K model is a tiny model and it was trained as follows (requires a GPU):
# python train.py \
#     Andrej Karpathy                        Me
#     ---------------                        ------------------------------------
#     --out_dir="outmini"                    --out_dir="outmini" \
#     --batch_size=128 \                     --batch_size=128 \
#     --max_seq_len=512 \                    --max_seq_len=512 \
#     --gradient_accumulation_steps=1 \      --gradient_accumulation_steps=1 \
#     --vocab_source="custom" \              --vocab_source="custom" \
#     --vocab_size=512 \                     --vocab_size=1024 \
#     --dim=32 \                             --dim=32 \
#     --n_layers=5 \                         --n_layers=2 \
#     --n_heads=8 \                          --n_heads=8 \
#     --n_kv_heads=4 \                       --n_kv_heads=4 \
#     --multiple_of=4 \                      --multiple_of=4 \
#     --learning_rate=1e-3 \                 --learning_rate=1e-3 \
#     --dropout=0.05 \                       --dropout=0.05 \
#     --weight_decay=0.01 \                  --weight_decay=0.01 \
#     --max_iters=100000 \                   --max_iters=100000 \
...
#     --compile=True
#     --log_interval=250 \                   --log_interval=250 \
...
date
echo "convert tokenizer to .model... -----------"
python tokenizer.py --tokenizer-model=data/tok1024.model

date
echo "inference... -----------"
INFERENCE_CMD="./run outmini/model.bin -z data/tok1024.bin"
echo $INFERENCE_CMD
$INFERENCE_CMD
